 ...
 */
public class _Neo4jRestClientTest {
...
//        this.cut = new Neo4jRestClient(new PrintWriter(System.out), directory, this.closeable);
//    }
//
//    @Test
//    public void autoClose() throws Exception {
//        final String directory = root.getRoot().getAbsolutePath();
//        try (Neo4jRestClient bucket = new Neo4jRestClient(new PrintWriter(System.out), directory, this.closeable);) {
//            bucket.begin();
//        }
